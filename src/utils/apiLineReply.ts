                                            ...
                                            contents: [
                                                {
                                                    ...
                                                    contents: [
                                                        ...
                                                        {
                                                            type: "text",
                                                            text: "แจ้งเตือนเขตปลอดภัย", // ✅ ปรับหัวข้อตามโจทย์
                                                            size: "xl",
                                                            color: "#FFFFFF",
                                                            weight: "bold",
                                                            flex: 1,
                            ...
                            contents: [
                                ...
                                // ✅ หมายเหตุ
                                {
                                    ...
                                    contents: [
                                        ...
                                        {
                                            type: "text",
                                            text: "ข้าพเจ้ายินยอมเปิดเผยข้อมูลตำแหน่งปัจจุบันของผู้ที่มีภาวะพึ่งพิง เพื่อการช่วยเหลือฉุกเฉิน",
                                            size: "xxs",
                                            color: "#6B7280",
                                            wrap: true,
                                            margin: "sm"
                                            ...
                                            contents: [
                                                {
                                                    ...
                                                    contents: [
                                                        ...
                                                        {
                                                            type: "text",
                                                            text: "แจ้งอุณหภูมิสูง", // ✅ ปรับหัวข้อตามโจทย์
                                                            size: "xl",
                                                            color: "#FFFFFF",
                                                            weight: "bold",
                                                            flex: 1,
